...
<template>
  <div class="student-card">
    ...
    <div class="bg-primary">
      <p class="card-header-text text-center">{{ $lang.BASIC_DETAILS }}</p>
    </div>
    ...
    <v-row no-gutters :class="{'px-2': $vuetify.breakpoint. smAndDown, 'px-6': $vuetify.breakpoint. mdAndUp}"
           class="mx-0 my-1 text-left" v-if="academic_data">
    ...
    <div class="bg-primary">
      <p class="card-header-text text-center">{{ $lang.PROFESSIONAL_DETAILS }}</p>
    </div>
    <v-row v-for="grade in grade_list" :key="grade.id"
           :class="{'px-2': $vuetify.breakpoint. smAndDown, 'px-9': $vuetify.breakpoint. mdAndUp}"
    ...
    <v-row :class="{'px-2': $vuetify.breakpoint. smAndDown, 'px-6': $vuetify.breakpoint. mdAndUp}"
        ...
        <div class="field-wrapper">
          ...
          <div class="d-inline-block  v-align-top">
            ...
            <div v-for="item in morning_time_slots" :key="item.id">
              <v-checkbox
                  :disabled="!tutor_data.time_slots_id_list.includes(item.id)"
                  :input-value="tutor_data.time_slots_id_list.includes(item.id)"
      ...
      <v-col class="py-0" cols="12" md="4" sm="6">
        <div class="field-wrapper">
          ...
          <p class="text-1" style="width: 100%">{{ tutor_data.special_concern || '-' }}</p>
        </div>
      </v-col>
    </v-row>
...
<script>
export default {
  props: ["grade_list", "tutor_name", 'mobile', "tutor_data", 'evening_time_slots',
    'morning_time_slots', 'afternoon_time_slots', 'academic_data'],
  components: {
