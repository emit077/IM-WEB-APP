    ...
    <v-form ref="address_form" lazy-validation>
      <v-row :class="{'px-0': $vuetify.breakpoint. smAndDown, 'px-0': $vuetify.breakpoint. mdAndUp}" class="ma-0">
        ...
        <v-col :class="{'px-0 py-0': $vuetify.breakpoint. smAndDown, 'pl-0': $vuetify.breakpoint. mdAndUp}" cols="12"
               md="6">
          <div class="form-filed-wrapper">
            <label class="label-text-1"> {{ $lang.GENDER }} <sup
        ...
        <v-col :class="{'px-0 py-0': $vuetify.breakpoint. smAndDown, 'pl-0': $vuetify.breakpoint. mdAndUp}" cols="12"
               md="6">
          <div class="form-filed-wrapper">
            <label class="label-text-1"> {{ $lang.DATE_OF_BIRTH }} <sup
                class="error--text">*</sup></label>
            <v-menu
                v-model="bob_menu"
        ...
        <v-col :class="{'px-0 py-0': $vuetify.breakpoint. smAndDown, 'pl-0': $vuetify.breakpoint. mdAndUp}" cols="12"
               md="6">
          <div class="form-filed-wrapper">
            <label class="label-text-1"> {{ $lang.ADDRESS }} <sup
                class="error--text">*</sup></label>
            <v-textarea
        ...
        <v-col :class="{'px-0 py-0': $vuetify.breakpoint. smAndDown, 'pl-0': $vuetify.breakpoint. mdAndUp}" cols="12"
               md="6">
          <div class="form-filed-wrapper">
            <label class="label-text-1"> {{ $lang.PIN_CODE }} <sup
                class="error--text">*</sup></label>
            <v-text-field
          ...
          <div class="form-filed-wrapper">
            <label class="label-text-1"> {{ $lang.CITY }} <sup
                class="error--text">*</sup></label>
            <v-text-field
                v-model="city"
      ...
      <div>
        ...
        <v-row class="ma-0">
          ...
          <v-col :class="{'pa-0': $vuetify.breakpoint. smAndDown, 'px-1 py-0': $vuetify.breakpoint. mdAndUp}" cols="12"
                 md="3">
            <label class="label-text-1"> {{ $lang.STATUS }} <sup
                class="error--text">*</sup></label>
            <v-select
...
export default {
  ...
  data: () => ({
    ...
    collage_status_options: ["Pursuing Graduations", "Graduate", "Pursuing Post-Graduations", "Post-Graduate"],
    form: {
      email: "",
      father_name: "",
      gender: "",
  ...
  methods: {
    ...
    saveAddressDetails() {
      const self = this
      if (this.$refs.address_form.validate() == false && !this.form.longitude && !this.form.latitude)
        return false
      this.$store.dispatch("setPageLoader", false);
