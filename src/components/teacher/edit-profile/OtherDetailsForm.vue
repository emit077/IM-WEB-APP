        ...
        <v-col class="py-0" cols="12" md="12">
          <div class="form-filed-wrapper">
            ...
            <div class="px-2 d-flex v-align-top">
              <v-radio-group
                class="py-0 my-1"
                v-model="form.personal_computer"
                row
                hide-details
              >
                <v-radio label="Yes" :value="true" hide-details class="mr-3"></v-radio>
...
export default {
  ...
  methods: {
    ...
    Save() {
      ...
      form.append("class_mode_preference", JSON.stringify(self.form.class_mode));
      form.append("suitable_days", JSON.stringify(self.form.suitable_days));
      form.append("teaching_preference", JSON.stringify(self.form.teaching_preference));

      form.append("personal_computer", self.form.personal_computer ? "Yes" : "No");
      form.append("personal_vehicle", self.form.personal_vehicle ? "Yes" : "No");

      if (this.tutor_table_id) form.append("tutor_table_id", self.tutor_table_id);
