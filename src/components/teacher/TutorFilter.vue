  ...
  methods: {
    getClassList() {
      ...
      const successHandler = (response) => {
        self.class_list = response.data.grade_list;
      };
    ...
    applyFilter() {
      ...
      const self = this;
      this.$store.dispatch("tutor/setFilter", {
        city_id_list: self.filter_data.city_id_list,
        class_id_list: self.filter_data.class_id_list,
        student_status_list: self.filter_data.student_status_list,
